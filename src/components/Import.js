...
export const Import = (props) => {
    const {title, action, template, visible, setVisible, MoreOption, handleData} = props
    ...
    return (visible && <Dialogz title={"Import " + title} visible={visible} onHide={() => setVisible(false)} width="800px" >
        <div className="card">
